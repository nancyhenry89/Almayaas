<?php /* Template Name: Brands Template */ get_header(); ?>
...
<div class="banner" id="brandsBanner">
							<img src="<?php echo get_post_meta( get_the_ID(), 'brandsBanner', true ); ?>">
							</img>
...
while ( $loop->have_posts() ) : $loop->the_post(); ?>
				...
				<div id="<?php echo get_post_meta( get_the_ID(), 'brandOrder', true ); ?>" class="brand" style="order:<?php echo get_post_meta( get_the_ID(), 'brandOrder', true ); ?>">
				...
				<div class="details">
					...
					<div class="b-desc"><?php echo get_post_meta( get_the_ID(), 'brandText', true ); ?></div>
